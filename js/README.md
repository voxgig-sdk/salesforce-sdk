# Salesforce JavaScript SDK



The JavaScript SDK for the Salesforce API — an entity-oriented client with full async/await support.
...
salesforce/
├── src/
│   ├── SalesforceSDK.js        # Main SDK class
