# Salesforce JavaScript SDK Reference

Complete API reference for the Salesforce JavaScript SDK.
...
```ts
new SalesforceSDK(options?: object)
```
...
#### `SalesforceSDK.test(testopts?, sdkopts?)`
...
**Returns:** `SalesforceSDK` instance in test mode.
...
Return the parent `SalesforceSDK` instance.
