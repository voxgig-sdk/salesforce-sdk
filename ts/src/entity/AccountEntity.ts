...
class AccountEntity extends SalesforceEntityBase<Account> {
  ...
  make(this: AccountEntity) {
    return new AccountEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: AccountLoadMatch, ctrl?: Control): Promise<AccountEntity> {
  ...
  async create(this: any, reqdata?: AccountCreateData, ctrl?: Control): Promise<AccountEntity> {
  ...
  async update(this: any, reqdata?: AccountUpdateData, ctrl?: Control): Promise<AccountEntity> {
  ...
  async remove(
    this: any, reqmatch?: AccountRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<AccountEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
