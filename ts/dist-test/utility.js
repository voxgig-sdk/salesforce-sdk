...
function envOverride(m) {
    if ('TRUE' === process.env.SALESFORCE_TEST_LIVE ||
        'TRUE' === process.env.SALESFORCE_TEST_OVERRIDE) {
    ...
    m.SALESFORCE_TEST_EXPLAIN = process.env.SALESFORCE_TEST_EXPLAIN || m.SALESFORCE_TEST_EXPLAIN;
    return m;
}
