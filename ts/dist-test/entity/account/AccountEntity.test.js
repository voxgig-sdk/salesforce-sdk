...
(0, node_test_1.describe)('AccountEntity', async () => {
    ...
    (0, node_test_1.test)('instance', async () => {
        const testsdk = __1.SalesforceSDK.test();
...
function basicSetup(extra) {
    ...
    let client = __1.SalesforceSDK.test(options, extra);
    ...
    if (live) {
        ...
        client = new __1.SalesforceSDK(merge([
