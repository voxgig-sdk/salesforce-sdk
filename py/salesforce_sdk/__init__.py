...
from salesforce_sdk.utility import register

# Load features
from salesforce_sdk.feature.base_feature import SalesforceBaseFeature
from salesforce_sdk.features import _has_feature, _make_feature
...
class SalesforceSDK:
    ...
    def get_utility(self):
        return SalesforceUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("SalesforceSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Account(self, data=None) -> "AccountEntity":
        ...
        from salesforce_sdk.entity.account_entity import AccountEntity
        return AccountEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "SalesforceSDK":
        if sdkopts is None:
            sdkopts = {}
