# Salesforce SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions SalesforceSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both SalesforceSDK(...) and SalesforceSDK.test(...) become
#      SalesforceSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "salesforce_sdk"
_SDK_CLASS = "SalesforceSDK"
