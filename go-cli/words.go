...
func registerSDKWords(r *eng.Registry, client *sdk.SalesforceSDK) {
...
func runOp(client *sdk.SalesforceSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
