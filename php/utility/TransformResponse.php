...
// Salesforce SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class SalesforceTransformResponse
{
    public static function call(SalesforceContext $ctx): mixed
    {
        ...
        $transform = SalesforceHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
