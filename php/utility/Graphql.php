...
// Salesforce SDK utility: graphql
//
...
class SalesforceGraphql
{
    ...
    // equivalent.
    public static function body(SalesforceContext $ctx): mixed
    {
    ...
    public static function errors(SalesforceContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
