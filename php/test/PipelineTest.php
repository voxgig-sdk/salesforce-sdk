...
{
    private static function utility(): SalesforceUtility
    {
        return new SalesforceUtility();
    }
    ...
    private static function ctx(array $over = []): SalesforceContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new SalesforceContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new SalesforceOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof SalesforceError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new SalesforceOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = SalesforceMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new SalesforceOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = SalesforceMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new SalesforceOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = SalesforceMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new SalesforceSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = SalesforceMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        ...
        [, $err] = SalesforceMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new SalesforceSpec([]),
            'response' => null,
            'result' => new SalesforceResult([]),
        ]);
        [, $err] = SalesforceMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new SalesforceSpec(['step' => 's']),
            'response' => new SalesforceResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new SalesforceResult([]),
        ]);
        [, $err] = SalesforceMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new SalesforceSpec(['step' => 's']),
            'response' => new SalesforceResponse(self::resp(200, ['v' => 1])),
            'result' => new SalesforceResult([]),
        ]);
        [, $err] = SalesforceMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new SalesforceSpec(['step' => 's']),
            'response' => new SalesforceResponse(self::resp(200, ['v' => 2])),
            'result' => new SalesforceResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        SalesforceMakeResponse::call($ctx);
    ...
    {
        $preset = new SalesforceResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new SalesforceSpec([]),
            'response' => new SalesforceResponse([]),
            'result' => new SalesforceResult([]),
        ...
        [$got, $err] = SalesforceMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new SalesforceResult([])]);
        [, $err] = SalesforceMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new SalesforceSpec([]), 'result' => null]);
        [, $err] = SalesforceMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new SalesforceSpec(['step' => 's']),
            'result' => new SalesforceResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new SalesforceOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = SalesforceMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new SalesforceSpec(['step' => 's']),
            'result' => new SalesforceResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new SalesforceOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = SalesforceMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new SalesforceResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new SalesforceSpec([]),
            'result' => new SalesforceResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = SalesforceMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = SalesforceMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new SalesforceError('boom', 'boom');
        $utility->fetcher = function (SalesforceContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new SalesforceSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = SalesforceMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (SalesforceContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = SalesforceMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(SalesforceResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        SalesforceMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (SalesforceContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new SalesforceSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = SalesforceMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new SalesforceResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new SalesforceSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = SalesforceMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = SalesforceMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = SalesforceMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new SalesforceResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, SalesforceDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new SalesforceResult(['ok' => false])]);
        $this->expectException(SalesforceError::class);
        SalesforceDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new SalesforceResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', SalesforceMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        SalesforceMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new SalesforceBaseFeature();
        $b = new SalesforceBaseFeature();
        SalesforceFeatureAdd::call($ctx, $a);
        SalesforceFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): SalesforceBaseFeature
    {
        $f = new SalesforceBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        SalesforceFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): SalesforceContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new SalesforceSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = SalesforcePrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        SalesforcePrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new SalesforceResponse(['headers' => null]),
            'result' => new SalesforceResult([]),
        ]);
        SalesforceResultHeaders::call($ctx);
