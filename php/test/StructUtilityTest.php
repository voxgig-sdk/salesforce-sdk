...
// Salesforce SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = SalesforceOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(SalesforceOmni::structfix($now, Struct::undef()))
                        !== json_encode(SalesforceOmni::structfix($val, Struct::undef()))) {
