...
// Salesforce SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (SalesforceSDK::test)
...
{
    private const SDK_CLASS = 'SalesforceSDK';
    ...
    private const SDK_BASE = 'salesforce_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../salesforce_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
