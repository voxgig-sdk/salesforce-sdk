...
class SalesforceTestRunner
{
    ...
    {
        $live = self::getenv('SALESFORCE_TEST_LIVE');
        $override = self::getenv('SALESFORCE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('SALESFORCE_TEST_EXPLAIN');
...
class_alias('SalesforceTestRunner', 'Runner');
class_alias('SalesforceHelpers', 'Helpers');
