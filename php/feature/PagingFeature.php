...
class SalesforcePagingFeature extends SalesforceBaseFeature
{
    ...
    private function _graphql_pre_request(SalesforceContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(SalesforceContext $ctx): bool
    {
