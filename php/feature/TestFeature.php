...
// Salesforce SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class SalesforceTestFeature extends SalesforceBaseFeature
{
    ...
    public function init(SalesforceContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (SalesforceContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = SalesforceParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (SalesforceContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(SalesforceContext $ctx, $op, $args): array
    {
