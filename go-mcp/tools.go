...
type Args struct {
	Entity string         `json:"entity" jsonschema:"account"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.SalesforceSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "salesforce_list",
		Description: "List records from Salesforce. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "salesforce_load",
		Description: "Load a single record from Salesforce. " +
...
func runOp(client *sdk.SalesforceSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.SalesforceSDK, name string) (sdk.SalesforceEntity, error) {
