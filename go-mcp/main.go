// Command Salesforce-mcp is an MCP server exposing the Salesforce
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Salesforce_list  — list records of an entity
//	Salesforce_load  — load a single record of an entity
//
