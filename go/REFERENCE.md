# Salesforce Golang SDK Reference

Complete API reference for the Salesforce Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *SalesforceSDK`
...
#### `Account(data map[string]any) SalesforceEntity`
