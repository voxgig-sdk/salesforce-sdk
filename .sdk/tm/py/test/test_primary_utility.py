...
from projectname_sdk import SalesforceSDK
from projectname_sdk.core.spec import SalesforceSpec
from projectname_sdk.core.result import SalesforceResult
from projectname_sdk.core.response import SalesforceResponse
from projectname_sdk.core.operation import SalesforceOperation
from projectname_sdk.core.error import SalesforceError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import SalesforceBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return SalesforceError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = SalesforceSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = SalesforceSDK.test(None, None)
        ...
        class TestInitFeature(SalesforceBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(SalesforceBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = SalesforceSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = SalesforceSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = SalesforceSDK.test(None, setup_opts)
