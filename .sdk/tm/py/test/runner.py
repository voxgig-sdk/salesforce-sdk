...
class SalesforceTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = SalesforceTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = SalesforceTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = SalesforceTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
