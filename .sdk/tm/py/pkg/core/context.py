...
from projectname_sdk.core.control import SalesforceControl
...
class SalesforceContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, SalesforceSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, SalesforceResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, SalesforceResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return SalesforceError(code, msg, self)
