...
// Salesforce SDK ratelimit feature
...
class SalesforceRatelimitFeature extends SalesforceBaseFeature
{
    ...
    private function _acquire(SalesforceContext $ctx): void
    {
    ...
    private function _track(SalesforceContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
