...
// Salesforce SDK timeout feature
...
class SalesforceTimeoutFeature extends SalesforceBaseFeature
{
    ...
    private function _with_timeout(SalesforceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(SalesforceContext $_ctx, float $ms): void
    {
        $client = $this->client;
