...
// Salesforce SDK utility: fetcher
...
class SalesforceFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; SalesforceSDK/1.0)';
    ...
    public static function call(SalesforceContext $ctx, string $fullurl, array $fetchdef): array
    {
