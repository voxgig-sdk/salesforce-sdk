...
|---|---|---|
| `js/` | @voxgig-sdk/salesforce-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/salesforce | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/salesforce-js \
      --repository voxgig-sdk/salesforce-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/salesforce-js` shows it, and
`npm trust revoke @voxgig-sdk/salesforce-js --id=<id>` removes it.
